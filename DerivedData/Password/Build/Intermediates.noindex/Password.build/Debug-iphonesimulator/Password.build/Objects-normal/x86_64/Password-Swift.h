...
#ifndef PASSWORD_SWIFT_H
#define PASSWORD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Password",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8Password11AppDelegate")
...
SWIFT_CLASS("_TtC8Password13SceneDelegate")
...
SWIFT_CLASS("_TtC8Password14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified resultLabel1;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified resultLabel2;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified resultLabel3;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified resultLabel4;
